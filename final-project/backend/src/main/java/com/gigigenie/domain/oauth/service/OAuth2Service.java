...
public class OAuth2Service implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private Member saveOrUpdate(OAuth2Attributes attributes) {
        ...
        Member member = memberRepository.findByEmail(attributes.getEmail())
            .map(entity -> {
                log.info("기존 사용자 정보 업데이트: email={}, name={}", entity.getEmail(),
                    attributes.getName());
            ...
            .orElseGet(() -> {
                log.info("새 사용자 생성: email={}, name={}", attributes.getEmail(),
                    attributes.getName());
    ...
    public Map<String, Object> generateTokens(CustomOAuth2User oAuth2User,
